...
DB_CREATE_WALLETADDRESS_TYPE = f"""
CREATE TABLE IF NOT EXISTS walletaddresstype (
    id INTEGER NOT NULL PRIMARY KEY,
    name VARCHAR(20) NOT NULL UNIQUE
);
"""
...
CREATE TABLE IF NOT EXISTS wallet (
    ...
    CONSTRAINT FK_wallet_type FOREIGN KEY (addresstype) REFERENCES walletaddresstype(id) ON UPDATE CASCADE ON DELETE RESTRICT
);
"""

DB_CREATE_CHILDADDRESS_TYPE = f"""
CREATE TABLE IF NOT EXISTS childaddresstype (
    id INTEGER NOT NULL PRIMARY KEY,
    name VARCHAR(20) NOT NULL UNIQUE
);
"""
...
CREATE TABLE IF NOT EXISTS walletchild (
    ...
    CONSTRAINT FK_child_parent FOREIGN KEY (parent_id) REFERENCES wallet(id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT FK_child_type FOREIGN KEY (type) REFERENCES childaddresstype(id) ON UPDATE CASCADE ON DELETE RESTRICT
);
"""
...
{DB_CREATE_WALLETADDRESS_TYPE}
{DB_CREATE_WALLET}
{DB_CREATE_CHILDADDRESS_TYPE}
