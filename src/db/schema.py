...
CREATE TABLE IF NOT EXISTS wallet (
    ...
    CONSTRAINT FK_wallet_type FOREIGN KEY (addresstype) REFERENCES walletaddresstype(id) ON UPDATE CASCADE ON DELETE CASCADE
);
"""
...
CREATE TABLE IF NOT EXISTS walletchild (
    ...
    CONSTRAINT FK_child_type FOREIGN KEY (type) REFERENCES childaddresstype(id) ON UPDATE CASCADE ON DELETE CASCADE
);
"""
